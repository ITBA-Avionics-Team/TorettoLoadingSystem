...
String create_LC_status_packet_str(SystemStatus status) {
  ...
  return state_str + tank_pressure_str + tank_temperature_str + loading_line_pressure_str + obec_battery_voltage_str + lc_battery_voltage_str + status_flags_str + wind_str;
}
