...
TimedSimulationCommand NOMINAL_STANDBY_SCENARIO[] = {
  {1000, SimulationCommand(SENSOR_MODULE, 0, "14")}, // get_loading_line_pressure_bar 14
  ...
  {7000, SimulationCommand(SENSOR_MODULE, 0, "80")}, // get_loading_line_pressure_bar 110
