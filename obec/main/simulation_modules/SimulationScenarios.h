...
TimedSimulationCommand NOMINAL[] = {
  {1000, SimulationCommand(SENSOR_MODULE, 0, "60")}, // get_tank_pressure_bar 60
  ...
  {1000, SimulationCommand(SENSOR_MODULE, 4, "0")}, // get_tank_depress_vent_valve_open 0
  {1000, SimulationCommand(SENSOR_MODULE, 5, "0")}, // get_engine_valve_open 0
};

TimedSimulationCommand PRESSURE_ABORT[] = {
  {1000, SimulationCommand(SENSOR_MODULE, 0, "60")}, // get_tank_pressure_bar 60
  {1000, SimulationCommand(SENSOR_MODULE, 1, "20")}, // get_tank_temperature_celsius 20
  {1000, SimulationCommand(SENSOR_MODULE, 2, "24")}, // get_tank_depres_vent_temperature_celsius 24
  {1000, SimulationCommand(SENSOR_MODULE, 3, "4.17")}, // get_obec_battery_voltage_volt 4.17
  ...
  {4000, SimulationCommand(SENSOR_MODULE, 0, "98")}, // get_loading_line_pressure_bar 98
  {7000, SimulationCommand(SENSOR_MODULE, 0, "110")}, // get_loading_line_pressure_bar 110
  {13000, SimulationCommand(SENSOR_MODULE, 0, "90")}, // get_loading_line_pressure_bar 90
};
