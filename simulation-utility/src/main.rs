...
const COMMUNICATION_MODULE_OBEC_STATUS_BASE: &[u8] = b"CM,1,001414.125.24.12)|";
const COMMUNICATION_MODULE_OBEC_STATUS_HIGH_PRESSURE: &[u8] = b"CM,1,010914.125.24.12)|";
const COMMUNICATION_MODULE_OBEC_STATUS_LOW_TANK_VENT_TEMPERATURE: &[u8] = b"CM,1,010905.125.24.12)|";
